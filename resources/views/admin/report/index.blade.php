...
@push('javascript')
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/reports/' + id, ref);
        }
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">بيئتي
        ...
        <!--end::Separator-->
        <!--begin::Description-->
        <small class="text-muted fs-7 fw-bold my-1 ms-1">التقارير</small>
        <!--end::Description-->
    </h1>
@endsection
    ...
    <div class="card p-3">
        ...
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a data-bs-toggle="modal" data-bs-target="#kt_modal_1" class="btn btn-primary" title=""
                data-bs-original-title="إضافة تقرير">
                ...
                <form id="create_form" onsubmit="event.preventDefault(); performStore()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label for="" class="mb-2">عنوان التقرير باللغة العربية</label>
                            <input class="form-control" type="text" name="title_ar" required>
                        </div>

                        <div class="form-group">
                            <label for="" class="mb-2">عنوان التقرير باللغة الانجليزية</label>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_2">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('reports.update', 'test') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf
                        @method('PUT')
                        <div class="form-group mb-3">
                        ...
                        <input type="hidden" class="form-control" name="report_id" id="report_id">
                        <div class="form-group">
                            <label for="" class="mb-2">عنوان التقرير باللغة الانجليزية</label>
