...
@section('content')
    ...
    <div class="card p-3">
        ...
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a href="{{ route('programs.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="" data-bs-original-title="إضافة برنامج">
                ...
                @foreach ($programs as $item)
                    <tr>
                        ...
                        <td><img width="80px" height="60px" style="border-radius: 7px"
                                src="{{ asset("storage/images/programs/$item->image") }}"></td>
                        <td>{{ $item->title_ar }}</td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('programs.edit', [$item->id]) }}"><i
