...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">بيئتي
        ...
        <small class="text-muted fs-7 fw-bold my-1 ms-1">عنا (من نحن)</small>

        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
        <small class="text-muted fs-7 fw-bold my-1 ms-1">تعديل من نحن</small>
    </h1>
@endsection
                    ...
                    <form action="{{ route('about-us.update', [$about->id]) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" value="{{ $about->title_ar }}"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="asd" name="title_en"
                                    value="{{ $about->title_en }}" title="يرجي ادخال العنوان باللغة الانجليزية"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="description_ar"
                                    rows="3" required>{{ $about->description_ar }}</textarea>
                            </div>
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextar123123ea" name="description_en"
                                    rows="3" required>{{ $about->description_en }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url({{ asset("storage/images/about-us/$about->image") }})"></div>
