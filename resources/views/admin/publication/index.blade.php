...
@push('javascript')
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/publications/' + id, ref);
        }
        ...
        $('#kt_modal_2').on('show.bs.modal', function(event) {
            ...
            var publication_id = button.data('publication_id')
            // var image = button.data('image')
            var modal = $(this)
            modal.find('.modal-body #title_ar').val(title_ar);
            modal.find('.modal-body #title_en').val(title_en);
            modal.find('.modal-body #publication_id').val(publication_id);
...
@section('toolbar')
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">بيئتي
        ...
        <!--end::Separator-->
        <!--begin::Description-->
        <small class="text-muted fs-7 fw-bold my-1 ms-1">الاصدارات</small>
        <!--end::Description-->
    </h1>
@endsection
...
@include('layouts.alert')
    <div class="card p-3">
        ...
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a data-bs-toggle="modal" data-bs-target="#kt_modal_1" class="btn btn-primary" title=""
                data-bs-original-title="إضافة اصدار">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">إضافة اصدار</h5>
                ...
                <form id="create_form" onsubmit="event.preventDefault(); performStore()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label for="" class="mb-2">عنوان الاصدار باللغة العربية</label>
                            <input class="form-control" type="text" name="title_ar" required>
                        </div>

                        <div class="form-group">
                            <label for="" class="mb-2">عنوان الاصدار باللغة الانجليزية</label>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">تعديل الاصدار</h5>
                ...
                <form action="{{ route('publications.update', 'test') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf
                        @method('PUT')
                        <div class="form-group mb-3">
