...
@push('javascript')
    ...
    <script>
        function performDestroy(id, ref) {
            confirmDestroy('/admin/principles/' + id, ref);
        }
    </script>
@endpush
...
@include('layouts.alert')
    <div class="card p-3">
        ...
        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
            <a href="{{ route('principles.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="" data-bs-original-title="إضافة مبدأ">
                ...
                @foreach ($principles as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('principles.edit', [$item->id]) }}"><i
