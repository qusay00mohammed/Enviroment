...
<nav class="navbar navbar-expand-lg bg-light" id="navbar">
    <div class="container-fluid ">
        @if (App::getLocale() == 'ar')
        <a class="navbar-brand" href="{{ route('homePage') }}"><img src="{{ asset('website/imges/Group 8541.png') }}" alt=""></a>
        @else
        <a class="navbar-brand" href="{{ route('homePage') }}"><img src="https://paeep.ps/Content/site/imges/Group%208541.svg" alt=""></a>
        @endif
            ...
            <ul class="navbar-nav me-0 mb-0 mb-lg-0">
                ...
                <li>
                    <div class="areasearcheee">
                        <div class="inputser">
                            ...
                            <input type="text" placeholder="{{ __('nav.search') }}">
                        </div>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs("homePage") ? 'active' : '' }}" aria-current="page" href="{{ route('homePage') }}">{{ __('nav.home') }}</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle

                    @if (request()->is('*/about_association/*') or request()->is('*/principles') or request()->is('*/objectives'))
                        active
                    @endif
                    "
                    href="#" role="button" data-bs-toggle="dropdown"

                    aria-expanded="false">{{ __('nav.about us') }}</a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('about_association', [$item->id]) }}">{{ $item->title }}</a></li>
                        @endforeach

                        <li><a class="dropdown-item" href="{{ route('principles') }}">{{ __('nav.principles') }}</a></li>

                        <li><a class="dropdown-item" href="{{ route('objectives') }}">{{ __('nav.goals') }}</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle

                    @if (request()->is('*/reports') or request()->is('*/publications') or request()->is('*/visualLibrary'))
                        active
                    @endif
                    ...
                    <ul class="dropdown-menu ">
                        <li><a class="dropdown-item" href="{{ route('reports') }}"> {{ __('nav.reports') }}</a></li>
                        <li><a class="dropdown-item" href="{{ route('publications') }}"> {{ __('nav.publications') }}</a></li>
                        <li><a class="dropdown-item" href="{{ route('visualLibrary.index') }}">{{ __('nav.visual library') }}</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link
                    ...
                    " href="{{ route('news') }}">{{ __('nav.news and announcements') }}</a>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle

                    @if (request()->is('*/volunteer_request') or request()->is('*/job_request') or request()->is('*/company_request'))
                        active
                    @endif

                    " href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">{{ __('nav.join us') }}</a>

                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('volunteer.index') }}">{{ __('nav.volunteer with us') }}</a></li>

                        <li><a class="dropdown-item" href="{{ route('job.index') }}">{{ __('nav.apply for a job') }}</a></li>

                        <li><a class="dropdown-item" href="{{ route('company.index') }}">{{ __('nav.become a partner') }}</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    @if (request()->is('*/contact_us'))
                        active
                    @endif
                    " href="{{ route('contact_us.index') }}">{{ __('nav.contact us') }}</a>
                </li>
                ...
                @if (App::getLocale() == 'en')
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}"
                        role="button" data-bs-toggle="dropdown"
                        aria-expanded="false"> EN</a>

                    <ul class="dropdown-menu">
                        <li>
                            <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}" class="dropdown-item" href="#"> AR</a>
                        </li>
                    </ul>
                </li>
                @elseif (App::getLocale() == 'ar')
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}"
                        role="button" data-bs-toggle="dropdown"
                        aria-expanded="false"> AR</a>

                    <ul class="dropdown-menu">
                        <li>
                            <a rel="alternate" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="dropdown-item" href="#"> EN</a>
                        </li>
                    </ul>
                </li>
                @endif
